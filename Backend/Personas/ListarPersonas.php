<?php
	...
	try{	
	    $sql = 'SELECT p.* FROM  datatwit.peresona p  where p.Id !='.$_SESSION['Id'];
	    //echo $sql;
        foreach ($conexionOpen->query($sql) as $row) {
            ...
            $sql2 ="SELECT * FROM datatwit.amigos a where (a.Id_Persona_envia_Fk =".$_SESSION['Id']."  and a.Id_Persona_Reci_Fk =".$id_persona_diferente .") or (a.Id_Persona_Reci_Fk =".$_SESSION['Id']."  and a.Id_Persona_envia_Fk =".$id_persona_diferente .");" ;
            //echo $sql2;
